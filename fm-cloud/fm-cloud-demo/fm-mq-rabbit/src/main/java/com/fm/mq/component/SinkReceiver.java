...
//    }
    ...
    //    @Bean
    @ConditionalOnProperty(value = "spring.cloud.stream.rabbit.bindings.TestInput", matchIfMissing = false)
    ...
    //    @Bean
    @ConditionalOnProperty(value = "spring.cloud.stream.rabbit.bindings.TestInput", matchIfMissing = false)
//    @ConditionalOnProperty(value = "spring.cloud.stream.rabbit.bindings.TestInput.consumer.acknowledgeMode", havingValue = "MANUAL")
    @ConditionalOnExpression("'${spring.cloud.stream.rabbit.bindings.TestInput.consumer.acknowledgeMode}'=='MANUAL'")
